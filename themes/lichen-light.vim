...
let g:colors_name = "Lichen Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#d7dbe0 gui=NONE
...
hi PreProc        guifg=#5f87ad guibg=NONE gui=NONE
...
hi Todo           guifg=#5f87ad guibg=NONE gui=inverse,bold
