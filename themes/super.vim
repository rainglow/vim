...
let g:colors_name = "Super (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#323c47 gui=NONE
...
hi PreProc        guifg=#778da3 guibg=NONE gui=NONE
...
hi Todo           guifg=#778da3 guibg=NONE gui=inverse,bold
