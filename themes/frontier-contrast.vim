...
let g:colors_name = "Frontier Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#221f1c gui=NONE
...
hi PreProc        guifg=#a59a8a guibg=NONE gui=NONE
...
hi Todo           guifg=#a59a8a guibg=NONE gui=inverse,bold
