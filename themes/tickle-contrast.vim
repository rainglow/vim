...
let g:colors_name = "Tickle Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1d1d1e gui=NONE
...
hi PreProc        guifg=#7b7b84 guibg=NONE gui=NONE
...
hi Todo           guifg=#7b7b84 guibg=NONE gui=inverse,bold
