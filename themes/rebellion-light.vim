...
let g:colors_name = "Rebellion Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#e5ddce gui=NONE
...
hi PreProc        guifg=#727257 guibg=NONE gui=NONE
...
hi Todo           guifg=#727257 guibg=NONE gui=inverse,bold
