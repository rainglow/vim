...
let g:colors_name = "Box UK Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1f262d gui=NONE
...
hi PreProc        guifg=#7994ad guibg=NONE gui=NONE
...
hi Todo           guifg=#7994ad guibg=NONE gui=inverse,bold
