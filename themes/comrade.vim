...
let g:colors_name = "Comrade (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#3e4444 gui=NONE
...
hi PreProc        guifg=#719191 guibg=NONE gui=NONE
...
hi Todo           guifg=#719191 guibg=NONE gui=inverse,bold
