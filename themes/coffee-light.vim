...
let g:colors_name = "Coffee Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#e5e0e0 gui=NONE
...
hi PreProc        guifg=#877d7e guibg=NONE gui=NONE
...
hi Todo           guifg=#877d7e guibg=NONE gui=inverse,bold
