...
let g:colors_name = "Goldfish Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#16181a gui=NONE
...
hi PreProc        guifg=#798891 guibg=NONE gui=NONE
...
hi Todo           guifg=#798891 guibg=NONE gui=inverse,bold
