...
let g:colors_name = "Warlock (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#3f3551 gui=NONE
...
hi PreProc        guifg=#9d8bbc guibg=NONE gui=NONE
...
hi Todo           guifg=#9d8bbc guibg=NONE gui=inverse,bold
