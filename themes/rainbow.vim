...
let g:colors_name = "Rainbow (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#3b4047 gui=NONE
...
hi PreProc        guifg=#8095aa guibg=NONE gui=NONE
...
hi Todo           guifg=#8095aa guibg=NONE gui=inverse,bold
