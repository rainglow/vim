...
let g:colors_name = "Soup Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1f2026 gui=NONE
...
hi PreProc        guifg=#8a8ea8 guibg=NONE gui=NONE
...
hi Todo           guifg=#8a8ea8 guibg=NONE gui=inverse,bold
