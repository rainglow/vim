...
let g:colors_name = "Lichen Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#111921 gui=NONE
...
hi PreProc        guifg=#3f5972 guibg=NONE gui=NONE
...
hi Todo           guifg=#3f5972 guibg=NONE gui=inverse,bold
