...
let g:colors_name = "Spitfire Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#0d2824 gui=NONE
...
hi PreProc        guifg=#3d9aa0 guibg=NONE gui=NONE
...
hi Todo           guifg=#3d9aa0 guibg=NONE gui=inverse,bold
