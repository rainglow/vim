...
let g:colors_name = "Brave Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#191d23 gui=NONE
...
hi PreProc        guifg=#66647a guibg=NONE gui=NONE
...
hi Todo           guifg=#66647a guibg=NONE gui=inverse,bold
