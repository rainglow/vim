...
let g:colors_name = "Mellow Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#13110f gui=NONE
...
hi PreProc        guifg=#a09688 guibg=NONE gui=NONE
...
hi Todo           guifg=#a09688 guibg=NONE gui=inverse,bold
