...
let g:colors_name = "Slime (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#384147 gui=NONE
...
hi PreProc        guifg=#80919f guibg=NONE gui=NONE
...
hi Todo           guifg=#80919f guibg=NONE gui=inverse,bold
