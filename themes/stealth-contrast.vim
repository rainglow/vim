...
let g:colors_name = "Stealth Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1a1c1e gui=NONE
...
hi PreProc        guifg=#3d4144 guibg=NONE gui=NONE
...
hi Todo           guifg=#3d4144 guibg=NONE gui=inverse,bold
