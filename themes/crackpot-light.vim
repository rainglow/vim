...
let g:colors_name = "Crackpot Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#d3d0dd gui=NONE
...
hi PreProc        guifg=#888399 guibg=NONE gui=NONE
...
hi Todo           guifg=#888399 guibg=NONE gui=inverse,bold
