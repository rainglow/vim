...
let g:colors_name = "Patriot Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#191b1c gui=NONE
...
hi PreProc        guifg=#798b96 guibg=NONE gui=NONE
...
hi Todo           guifg=#798b96 guibg=NONE gui=inverse,bold
