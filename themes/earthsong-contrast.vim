...
let g:colors_name = "Earthsong Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#282521 gui=NONE
...
hi PreProc        guifg=#9a9082 guibg=NONE gui=NONE
...
hi Todo           guifg=#9a9082 guibg=NONE gui=inverse,bold
