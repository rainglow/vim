...
let g:colors_name = "Tonic Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#181a1c gui=NONE
...
hi PreProc        guifg=#67757a guibg=NONE gui=NONE
...
hi Todo           guifg=#67757a guibg=NONE gui=inverse,bold
