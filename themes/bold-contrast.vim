...
let g:colors_name = "Bold Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1e1a1a gui=NONE
...
hi PreProc        guifg=#6b6161 guibg=NONE gui=NONE
...
hi Todo           guifg=#6b6161 guibg=NONE gui=inverse,bold
