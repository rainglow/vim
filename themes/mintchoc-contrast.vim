...
let g:colors_name = "Mintchoc Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1c1712 gui=NONE
...
hi PreProc        guifg=#775a47 guibg=NONE gui=NONE
...
hi Todo           guifg=#775a47 guibg=NONE gui=inverse,bold
