...
let g:colors_name = "Crackpot (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#4d4a7a gui=NONE
...
hi PreProc        guifg=#837fc4 guibg=NONE gui=NONE
...
hi Todo           guifg=#837fc4 guibg=NONE gui=inverse,bold
