...
let g:colors_name = "Yule Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#161615 gui=NONE
...
hi PreProc        guifg=#bdae9a guibg=NONE gui=NONE
...
hi Todo           guifg=#bdae9a guibg=NONE gui=inverse,bold
