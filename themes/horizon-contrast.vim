...
let g:colors_name = "Horizon Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#181728 gui=NONE
...
hi PreProc        guifg=#734ea0 guibg=NONE gui=NONE
...
hi Todo           guifg=#734ea0 guibg=NONE gui=inverse,bold
