...
let g:colors_name = "Brave Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#e6eded gui=NONE
...
hi PreProc        guifg=#a3a0ba guibg=NONE gui=NONE
...
hi Todo           guifg=#a3a0ba guibg=NONE gui=inverse,bold
