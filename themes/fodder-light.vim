...
let g:colors_name = "Fodder Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#c0d3ca gui=NONE
...
hi PreProc        guifg=#788c82 guibg=NONE gui=NONE
...
hi Todo           guifg=#788c82 guibg=NONE gui=inverse,bold
