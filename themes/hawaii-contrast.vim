...
let g:colors_name = "Hawaii Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1c1c1a gui=NONE
...
hi PreProc        guifg=#998c86 guibg=NONE gui=NONE
...
hi Todo           guifg=#998c86 guibg=NONE gui=inverse,bold
