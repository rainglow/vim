...
let g:colors_name = "Horizon (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#3d3a59 gui=NONE
...
hi PreProc        guifg=#8b86ce guibg=NONE gui=NONE
...
hi Todo           guifg=#8b86ce guibg=NONE gui=inverse,bold
