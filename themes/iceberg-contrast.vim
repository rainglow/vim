...
let g:colors_name = "Iceberg Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#141718 gui=NONE
...
hi PreProc        guifg=#79a2ab guibg=NONE gui=NONE
...
hi Todo           guifg=#79a2ab guibg=NONE gui=inverse,bold
