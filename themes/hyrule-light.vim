...
let g:colors_name = "Hyrule Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#b3c6b4 gui=NONE
...
hi PreProc        guifg=#788c79 guibg=NONE gui=NONE
...
hi Todo           guifg=#788c79 guibg=NONE gui=inverse,bold
