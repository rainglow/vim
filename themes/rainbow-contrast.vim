...
let g:colors_name = "Rainbow Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#292e33 gui=NONE
...
hi PreProc        guifg=#5f6f7f guibg=NONE gui=NONE
...
hi Todo           guifg=#5f6f7f guibg=NONE gui=inverse,bold
