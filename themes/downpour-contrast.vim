...
let g:colors_name = "Downpour Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#191c23 gui=NONE
...
hi PreProc        guifg=#5a586d guibg=NONE gui=NONE
...
hi Todo           guifg=#5a586d guibg=NONE gui=inverse,bold
