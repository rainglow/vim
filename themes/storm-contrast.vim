...
let g:colors_name = "Storm Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#020e0f gui=NONE
...
hi PreProc        guifg=#1e7784 guibg=NONE gui=NONE
...
hi Todo           guifg=#1e7784 guibg=NONE gui=inverse,bold
