...
let g:colors_name = "Box UK (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#34424f gui=NONE
...
hi PreProc        guifg=#8babc6 guibg=NONE gui=NONE
...
hi Todo           guifg=#8babc6 guibg=NONE gui=inverse,bold
