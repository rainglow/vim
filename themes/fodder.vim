...
let g:colors_name = "Fodder (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#3d594b gui=NONE
...
hi PreProc        guifg=#75ba96 guibg=NONE gui=NONE
...
hi Todo           guifg=#75ba96 guibg=NONE gui=inverse,bold
