...
let g:colors_name = "Morass Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#262d2a gui=NONE
...
hi PreProc        guifg=#829e90 guibg=NONE gui=NONE
...
hi Todo           guifg=#829e90 guibg=NONE gui=inverse,bold
