...
let g:colors_name = "Spearmint Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#24302f gui=NONE
...
hi PreProc        guifg=#8bb7b2 guibg=NONE gui=NONE
...
hi Todo           guifg=#8bb7b2 guibg=NONE gui=inverse,bold
