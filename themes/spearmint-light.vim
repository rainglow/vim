...
let g:colors_name = "Spearmint Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#ceebe7 gui=NONE
...
hi PreProc        guifg=#729e98 guibg=NONE gui=NONE
...
hi Todo           guifg=#729e98 guibg=NONE gui=inverse,bold
