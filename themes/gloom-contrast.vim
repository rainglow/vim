...
let g:colors_name = "Gloom Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1b211c gui=NONE
...
hi PreProc        guifg=#668e81 guibg=NONE gui=NONE
...
hi Todo           guifg=#668e81 guibg=NONE gui=inverse,bold
