...
let g:colors_name = "Darkside (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#303333 gui=NONE
...
hi PreProc        guifg=#696b6e guibg=NONE gui=NONE
...
hi Todo           guifg=#696b6e guibg=NONE gui=inverse,bold
