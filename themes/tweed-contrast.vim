...
let g:colors_name = "Tweed Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#2c2f38 gui=NONE
...
hi PreProc        guifg=#676f84 guibg=NONE gui=NONE
...
hi Todo           guifg=#676f84 guibg=NONE gui=inverse,bold
