...
let g:colors_name = "Downpour Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#c5cccc gui=NONE
...
hi PreProc        guifg=#717a7a guibg=NONE gui=NONE
...
hi Todo           guifg=#717a7a guibg=NONE gui=inverse,bold
