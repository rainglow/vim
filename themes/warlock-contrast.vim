...
let g:colors_name = "Warlock Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#2b2042 gui=NONE
...
hi PreProc        guifg=#a49bc6 guibg=NONE gui=NONE
...
hi Todo           guifg=#a49bc6 guibg=NONE gui=inverse,bold
