...
let g:colors_name = "Coffee Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1e1818 gui=NONE
...
hi PreProc        guifg=#604f51 guibg=NONE gui=NONE
...
hi Todo           guifg=#604f51 guibg=NONE gui=inverse,bold
