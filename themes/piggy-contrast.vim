...
let g:colors_name = "Piggy Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#34282c gui=NONE
...
hi PreProc        guifg=#6a515a guibg=NONE gui=NONE
...
hi Todo           guifg=#6a515a guibg=NONE gui=inverse,bold
