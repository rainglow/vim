...
let g:colors_name = "Isotope Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1d1f23 gui=NONE
...
hi PreProc        guifg=#9ba8cc guibg=NONE gui=NONE
...
hi Todo           guifg=#9ba8cc guibg=NONE gui=inverse,bold
