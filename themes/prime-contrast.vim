...
let g:colors_name = "Prime Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#101019 gui=NONE
...
hi PreProc        guifg=#6b6b9b guibg=NONE gui=NONE
...
hi Todo           guifg=#6b6b9b guibg=NONE gui=inverse,bold
