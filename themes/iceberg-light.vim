...
let g:colors_name = "Iceberg Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#afc7cc gui=NONE
...
hi PreProc        guifg=#5e757a guibg=NONE gui=NONE
...
hi Todo           guifg=#5e757a guibg=NONE gui=inverse,bold
