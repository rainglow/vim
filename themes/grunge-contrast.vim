...
let g:colors_name = "Grunge Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1b1c18 gui=NONE
...
hi PreProc        guifg=#7f886f guibg=NONE gui=NONE
...
hi Todo           guifg=#7f886f guibg=NONE gui=inverse,bold
