...
let g:colors_name = "Newton Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1d1a21 gui=NONE
...
hi PreProc        guifg=#5b5266 guibg=NONE gui=NONE
...
hi Todo           guifg=#5b5266 guibg=NONE gui=inverse,bold
