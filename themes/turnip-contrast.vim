...
let g:colors_name = "Turnip Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1c1d1f gui=NONE
...
hi PreProc        guifg=#aea395 guibg=NONE gui=NONE
...
hi Todo           guifg=#aea395 guibg=NONE gui=inverse,bold
