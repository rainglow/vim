...
let g:colors_name = "FreshCut (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#383939 gui=NONE
...
hi PreProc        guifg=#939da8 guibg=NONE gui=NONE
...
hi Todo           guifg=#939da8 guibg=NONE gui=inverse,bold
