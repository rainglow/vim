...
let g:colors_name = "Scorch Light (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#eae3e3 gui=NONE
...
hi PreProc        guifg=#8c4e54 guibg=NONE gui=NONE
...
hi Todo           guifg=#8c4e54 guibg=NONE gui=inverse,bold
