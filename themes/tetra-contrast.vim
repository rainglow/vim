...
let g:colors_name = "Tetra Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#0b2126 gui=NONE
...
hi PreProc        guifg=#4f808c guibg=NONE gui=NONE
...
hi Todo           guifg=#4f808c guibg=NONE gui=inverse,bold
