...
let g:colors_name = "Mud Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#171413 gui=NONE
...
hi PreProc        guifg=#e3d7d6 guibg=NONE gui=NONE
...
hi Todo           guifg=#e3d7d6 guibg=NONE gui=inverse,bold
