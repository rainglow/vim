...
let g:colors_name = "Hub Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#2b3138 gui=NONE
...
hi PreProc        guifg=#8da5b7 guibg=NONE gui=NONE
...
hi Todo           guifg=#8da5b7 guibg=NONE gui=inverse,bold
