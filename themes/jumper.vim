...
let g:colors_name = "Jumper (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#2f3a3a gui=NONE
...
hi PreProc        guifg=#668787 guibg=NONE gui=NONE
...
hi Todo           guifg=#668787 guibg=NONE gui=inverse,bold
