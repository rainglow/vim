...
let g:colors_name = "Crisp Contrast (rainglow)"
...
hi CursorLine     guifg=NONE guibg=#1c151c gui=NONE
...
hi PreProc        guifg=#776377 guibg=NONE gui=NONE
...
hi Todo           guifg=#776377 guibg=NONE gui=inverse,bold
